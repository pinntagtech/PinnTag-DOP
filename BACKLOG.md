...
- [ ] Review 10 CROSS-COHORT groups before applying — a hand-curated
      manual-seeder record may lose to a scraped one under current scoring
      (cover 16 > hours 8 > taxonomy 4 > outlet 2 > oldest createdAt).
      **This is a policy call: surface it, do not decide alone.**
